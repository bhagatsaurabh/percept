...
[https://cdn.jsdelivr.net/npm/canvas-percept@1.0.16/dist/percept.js](https://cdn.jsdelivr.net/npm/canvas-percept@1.0.16/dist/percept.js)

```html
<script src="https://cdn.jsdelivr.net/npm/canvas-percept@1.0.16/dist/percept.js"></script>
```
